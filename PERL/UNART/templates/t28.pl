										...
										$sheet_name = undiacritic($data_sheet->{Name});
												...
												for my $row (1 .. $data_sheet->{MaxRow}) {
													if($row != 1){
														...
														#my $c2 = $data_sheet->get_cell($row, 10); next unless $c2; #emisiune
														...
														#my $c7 = $data_sheet->get_cell($row, 8); next unless $c7; #nr difuzari
